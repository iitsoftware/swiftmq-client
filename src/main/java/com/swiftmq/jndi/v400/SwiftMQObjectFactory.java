            ...
            if (ref.getClassName().equals(TopicImpl.class.getName())) {
                ...
                if (listenerName != null &&
                    ...
                    com.swiftmq.jms.v750.ConnectionFactoryImpl cf = new com.swiftmq.jms.v750.ConnectionFactoryImpl((String) listenerName.getContent(),
                            ...
                            Boolean.parseBoolean((String) jmsMessageIdEnabled.getContent()),
                            Boolean.parseBoolean((String) jmsMessageTimestampEnabled.getContent()),
                            Boolean.parseBoolean((String) useThreadContextCL.getContent()),
                            ...
                            Boolean.parseBoolean((String) intraVM.getContent()));
                    cf.setReconnectEnabled(Boolean.parseBoolean((String) reconnectEnabled.getContent()));
                    cf.setMaxRetries(Integer.parseInt((String) maxRetries.getContent()));
                    cf.setRetryDelay(Long.parseLong((String) retryDelay.getContent()));
                    cf.setDuplicateMessageDetection(Boolean.parseBoolean((String) duplicateMessageDetection.getContent()));
                    cf.setDuplicateBacklogSize(Integer.parseInt((String) duplicateBacklogSize.getContent()));
