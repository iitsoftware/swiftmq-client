...
public class ConnectionImpl extends RequestServiceRegistry
    ...
    public static final int CLIENT_VERSION = 500;
    ...
    DumpableFactory dumpableFactory = new com.swiftmq.jms.smqp.SMQPFactory(new com.swiftmq.jms.smqp.v500.SMQPFactory());
