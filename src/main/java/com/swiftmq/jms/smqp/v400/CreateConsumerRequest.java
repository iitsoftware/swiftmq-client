...
public class CreateConsumerRequest extends Request {
     ...
     * @param clientDispatchId
     * @param dispatchId
     * @SBGen Constructor assigns queue, messageSelector
     */
    public CreateConsumerRequest(int dispatchId, QueueImpl queue,
    ...
    public int getDumpId() {
        return SMQPFactory.DID_CREATE_CONSUMER_REQ;
    }
    ...
    public void accept(RequestVisitor visitor) {
        ((SMQPVisitor) visitor).visitCreateConsumerRequest(this);
    }
    ...
    public String toString() {
        return "[CreateConsumerRequest " + super.toString() + " queue=" + queue
