...
import com.swiftmq.jms.v610.po.POReconnect;
...
public class ConnectionImpl extends RequestServiceRegistry
    ...
    public static final int CLIENT_VERSION = 610;
    ...
    DumpableFactory dumpableFactory = new com.swiftmq.jms.smqp.SMQPFactory(new com.swiftmq.jms.smqp.v610.SMQPFactory());
