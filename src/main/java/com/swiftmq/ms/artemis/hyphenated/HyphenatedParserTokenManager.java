/* Generated By:JavaCC: Do not edit this line. HyphenatedParserTokenManager.java */
/*
...
package com.swiftmq.ms.artemis.hyphenated;
import java.io.*;
import java.util.*;
import com.swiftmq.ms.artemis.filter.*;

/** Token Manager. */
public class HyphenatedParserTokenManager implements HyphenatedParserConstants
{
...
/** Constructor. */
public HyphenatedParserTokenManager(SimpleCharStream stream){
...
/** Constructor. */
public HyphenatedParserTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
